<template>
  <div class="transfer container">
    <div class="token">
      <label>Token</label>
      <select id="select-token" v-model="tokenId2" name="select-token">
        <option
    ...
    <div class="send-to">
      ...
      <input
        ...
        @keyup="changeTo()"
      />
      <span v-if="isToValidating" class="spinner material-icons">sync</span>
      <span v-else-if="isToValid" class="success material-icons"
      ...
      <span
        ...
        >error_outline</span
      >
      <div v-if="!!resolvedAddress" class="info">
    ...
    <div class="row">
      <a class="balance" @click="setMaxAmount()"
    ...
    <div v-if="showAdvanced" class="advanced-content">
      <div class="group-free-mana">
        <input v-model="useFreeMana" type="checkbox" />
        <label for="kondor-payer">Use free mana</label>
      </div>
      <label for="max-mana">Max mana</label>
      <input v-model="maxMana" type="text" />
      <div v-if="!useFreeMana" class="group-payer">
        <label for="payer">Payer</label>
        <input v-model="payer" type="text" />
      </div>
    </div>
    <div class="actions">
      ...
      <button
        ...
        @click="transfer"
      >
        <span v-if="makingTransfer" class="loader2" />
